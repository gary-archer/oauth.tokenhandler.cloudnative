...
// Point to a local or deployed token handler
const OAUTH_AGENT_BASE_URL = 'https://bfflocal.authsamples-dev.com:446/oauth-agent';
const API_BASE_URL = 'https://bfflocal.authsamples-dev.com:444';
...
try {
    ...
    const oauthClient = new OAuthClient(OAUTH_AGENT_BASE_URL, API_BASE_URL);
